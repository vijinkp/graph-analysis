...
if __name__ == '__main__':
	...
	for yr1, yr2 in year_tup:
		print(yr1, yr2)
		yr1_graphs , yr1_labels = get_graphs(yr1, join(root_folder, str(yr1), 'communities_pajek'), master_map)
		yr2_graphs , yr2_labels = get_graphs(yr2, join(root_folder, str(yr2), 'communities_pajek'), master_map)
